...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('plugins/tempusdominus-bootstrap-4/css/te') }}mpusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
                ...
                <div class="row">
                            ...
                            <form action="/saveclient" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input maxlength="10" class="form-control" name="cname"
                                            placeholder=" enter Name" value="{{ old('cname') }}">
                                        @error('cname')
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Cemail
                                            <r style="color: red;">*</r>
                                        </label>
                                        <input class="form-control" name="cemail" id="exampleInputEmail1"
                                            placeholder="Enter email"value="{{ old('cemail') }}"><br>
                                        @error('cemail')
                                            <span class="alert text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input maxlength="10" class="form-control" name="ccontact" id="phone"
                                            placeholder="enter no"value="{{ old('ccontact') }}">
                                        @error('ccontact')
                                            <span class="alert text-danger">{{ $message }}</span>
                                        @enderror
                    ...
                    @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="cdob" id="exampleInputdate"
                                            placeholder="Enter DOB"value="{{ old('cdob') }}">
                                        @error('cdob')
                                            <span class="alert text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <textarea class="form-control" name="caddress" rows="2"> </textarea>
                                            @error('caddress')
                                                <span class="alert text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
