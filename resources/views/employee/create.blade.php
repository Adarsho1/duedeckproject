    ...
    <div class="wrapper">
                            ...
                            <form action="/saveemployee" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="20" name="ename"
        ...
        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" maxlength="10" class="form-control" name="econtact"
                                           id="phone" placeholder="enter no">
                                           @error('econtact')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="Date" class="form-control" id="exampleInputdate"
                                            name="edob" placeholder="Enter DOB">
                                            @error('edob')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <textarea name="eaddress" id="" class="form-control"></textarea>&nbsp;
                                            @error('eaddress')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
                                    </div>
